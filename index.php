...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/icons/Logo Gold.png"/>
<!--===============================================================================================-->
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="images/icons/Luthers Logo.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="product.php">Rent</a>
							</li>

							<li class="label1" data-label1="hot">
								<a href="shoping-cart.php">View Cart</a>
							</li>
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							<a href="#" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
								Gold-Farbener 5-flammiger Chandelier
							</a>
				...
				<div class="item-slick1" style="background-image: url(images/slide-01.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="900">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
									NEW SEASON
								</h2>
							</div>
								
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1900">
				...
				<div class="item-slick1" style="background-image: url(images/slide-02.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="lightSpeedIn" data-delay="900">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
									NEW SEASON
								</h2>
							</div>
								
							<div class="layer-slick1 animated visible-false" data-appear="slideInUp" data-delay="1900">
								<a href="product.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									BOOK CALL
								</a>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/slide-03.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="rotateInUpRight" data-delay="900">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
									NEW SEASON
								</h2>
							</div>
								
							<div class="layer-slick1 animated visible-false" data-appear="rotateIn" data-delay="1900">
								<a href="product.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									BOOK CALL
								</a>
							</div>
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".Props">
						Props
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".Linens">
						Linens
					</button>
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Props">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Props">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Wooden Drawer with Lid and Socket
								</a>
         ...
         <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Linens">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Linens">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Purple Sequin Overlay Square Tablecloth
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Linens">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Burgundy Pintuck Taffeta Round Tablecloth
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Lighting">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									RGBWA UV + Bateria Wireless LED DMX PAR
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Lighting">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Metro Luxe Lantern Golden Large
								</a>
...
<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item Lighting">
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="http://localhost/lamb/product.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					See More
				</a>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? Let us know in store at 215 Bamboo Drive, Meadow Brook Dr, Georgetown or call us on (592) 644 1658
					</p>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<form>
						<div class="wrap-input1 w-full p-b-4">
							<input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="lutherseventsrentalsguyana@gmail.com
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made By</i> by <a href="" target="_blank">WEBSTOCK </a> &amp; distributed by <a href="" target="_blank">WEBSTOCK DEVELOPMENT</a>
<!-- Link back to Colorlib can\'t be removed. Template is licensed under CC BY 3.0. -->
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<p class="stext-102 cl3 p-t-23">
								Modern Gold Stainless Steel Dining Chair with White Leather Cushion for Banquet and Wedding.
							</p>
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<p class="stext-102 cl3 p-t-23">
								white wimbledon garden chairs white resin folding chair for outdoor party and park use.
							</p>
